...
function CleanTable(){
   ...
   $query = "
   BEGIN 
      ibl.clean_proj_loc_summary('$uid'); 
   END;
   ";
...
function ExplainQuery0($query0){
   ...
   parameters for the ibl.ins_proj_loc_summary() procedure for this particular
...
function DisplayResults(){
   global $con, $uid;
   $query="select * from TABLE(ibl.v_proj_loc_summary('$uid'))";
   print <<<_HTML_
